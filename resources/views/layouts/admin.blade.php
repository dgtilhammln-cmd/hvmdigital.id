    ...
    <aside class="admin-sidebar" :class="sidebarOpen ? 'open' : ''">
        ...
        <nav style="flex:1;padding:6px 10px;">
            ...
            $nav = [
                ...
                ['route'=>'admin.megpreneur.index',       'label'=>'Megpreneur 2026',  'icon'=>'M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z'],
            ];
            ...
            <div style="margin-top:12px;border-top:1px solid rgba(255,255,255,0.05);padding-top:12px;">
                <div style="font-size:10px;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;color:rgba(255,255,255,0.2);padding:0 6px 6px;">Self Service</div>
                @php
                  $accountsActive = request()->routeIs('admin.accounts*');
                  $ordersActive   = request()->routeIs('admin.orders*');
                @endphp
                <a href="{{ route('admin.accounts.index') }}" class="nav-item {{ $accountsActive ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    Data Akun
                </a>
                <a href="{{ route('admin.orders.index') }}" class="nav-item {{ $ordersActive ? 'active' : '' }}">
