            ...
            <div class="hidden lg:flex items-center gap-3">
                ...
                <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" 
                        ...
                        <a href="{{ wa_link(setting('wa_message_default','Halo HVM Digital, saya ingin konsultasi')) }}" target="_blank" onclick="trackWaClick('navbar')" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-white hover:bg-[#f0fdf4] dark:hover:bg-[#075749]/50 hover:text-[#075749] dark:hover:text-[#9acb03] transition-colors">
                        ...
                        <a href="{{ route('register') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-white hover:bg-[#f0fdf4] dark:hover:bg-[#075749]/50 hover:text-[#075749] dark:hover:text-[#9acb03] transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/></svg>
                            Register
                        </a>
                        <a href="{{ route('login') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-white hover:bg-[#f0fdf4] dark:hover:bg-[#075749]/50 hover:text-[#075749] dark:hover:text-[#9acb03] transition-colors">
