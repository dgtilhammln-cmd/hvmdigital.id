...
<header id="navbar"
    ...
    <div :class="scrolled ? 'bg-[#075749]/95 dark:bg-[#061009]/95 backdrop-blur-xl shadow-[0_10px_30px_rgba(0,0,0,0.3)] py-3 border-b border-white/5' : 'bg-[#075749]/90 dark:bg-[#061009]/80 backdrop-blur-md py-5 border-b border-white/5'"
        ...
        <div class="container mx-auto px-4 lg:px-8 flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-3">
                ...
                {{-- WA CTA --}}
                <a href="{{ wa_link(setting('wa_message_default','Halo HVM Digital, saya ingin konsultasi')) }}"
                   target="_blank"
                   onclick="trackWaClick('navbar')"
                   class="relative group wa-btn flex items-center gap-2 bg-gradient-to-r from-[#075749] to-[#9acb03] text-white font-semibold text-sm px-6 py-2.5 rounded-full hover:scale-105 transition-all duration-300 shadow-[0_4px_15px_rgba(154,203,3,0.3)] hover:shadow-[0_8px_25px_rgba(154,203,3,0.5)]">
    ...
    <div x-show="mobileMenu"
        ...
        <a href="{{ wa_link(setting('wa_message_default','Halo HVM Digital')) }}"
           target="_blank" onclick="trackWaClick('mobile-menu')"
           class="wa-btn flex items-center justify-center gap-2 bg-gradient-to-r from-[#075749] to-[#9acb03] text-white font-semibold text-sm px-5 py-3.5 rounded-full mt-6 shadow-[0_4px_15px_rgba(154,203,3,0.3)]">
