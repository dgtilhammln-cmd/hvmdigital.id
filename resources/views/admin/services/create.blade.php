...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h2 class="text-white text-lg font-medium">Tambah Layanan Baru</h2>
        <p class="text-white/40 text-sm font-light">Masukkan detail produk/layanan digital terbaru Anda.</p>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 space-y-5">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="w-full bg-[#0a1f12] border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm focus:border-[#9acb03] focus:ring-1 focus:ring-[#9acb03] transition-all outline-none" placeholder="Contoh: Jasa SEO Bulanan">
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-white/70 text-xs font-medium mb-2">Icon SVG/Class (Opsional)</label>
                        <input type="text" name="icon" value="{{ old('icon') }}" placeholder="Contoh: heroicon-o-globe" class="w-full bg-[#0a1f12] border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm focus:border-[#9acb03] focus:ring-1 focus:ring-[#9acb03] transition-all outline-none">
                    </div>
                    <div>
                        <label class="block text-white/70 text-xs font-medium mb-2">Harga Mulai Dari (Opsional)</label>
                        <input type="number" name="price_start" value="{{ old('price_start') }}" placeholder="Contoh: 1500000" class="w-full bg-[#0a1f12] border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm focus:border-[#9acb03] focus:ring-1 focus:ring-[#9acb03] transition-all outline-none">
                    </div>
                </div>

                <div>
                    <label class="block text-white/70 text-xs font-medium mb-2">Ringkasan Deskripsi (Maks 300 Karakter)</label>
                    <textarea name="short_description" rows="2" maxlength="300" class="w-full bg-[#0a1f12] border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm focus:border-[#9acb03] focus:ring-1 focus:ring-[#9acb03] transition-all outline-none" placeholder="Teks singkat yang menerangkan layanan ini...">{{ old('short_description') }}</textarea>
                </div>

                <div>
                    <label class="block text-white/70 text-xs font-medium mb-2">Deskripsi Lengkap</label>
                    <textarea name="description" rows="6" class="w-full bg-[#0a1f12] border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm focus:border-[#9acb03] focus:ring-1 focus:ring-[#9acb03] transition-all outline-none" placeholder="Tuliskan detail, keunggulan, dan paket dari layanan ini...">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="bg-[#0a1f12] p-5 rounded-xl border border-white/5 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_title" value="{{ old('meta_title') }}" class="w-full bg-[#0d1f15] border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:border-[#9acb03] transition-all outline-none">
                    </div>
                    <div>
                        <label class="block text-white/70 text-xs font-medium mb-2">Meta Description</label>
                        <textarea name="meta_description" rows="2" class="w-full bg-[#0d1f15] border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:border-[#9acb03] transition-all outline-none">{{ old('meta_description') }}</textarea>
                    </div>
                    <div>
                        <label class="block text-white/70 text-xs font-medium mb-2">Meta Keywords</label>
                        <input type="text" name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="Contoh: jasa seo, seo surabaya" class="w-full bg-[#0d1f15] border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:border-[#9acb03] transition-all outline-none">
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-[#0a1f12] p-5 rounded-xl border border-white/5 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" class="w-full bg-[#0d1f15] border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:border-[#9acb03] transition-all outline-none">
                    </div>
                    
                    <div class="flex items-center gap-3 bg-[#0d1f15] p-3 rounded-lg border border-white/10">
                        <input type="checkbox" name="is_active" id="is_active" value="1" checked class="w-4 h-4 text-[#9acb03] bg-transparent border-white/20 rounded focus:ring-[#9acb03]">
