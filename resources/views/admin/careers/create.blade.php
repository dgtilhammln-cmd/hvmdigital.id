    ...
    <div class="bg-[#0d1f15] border border-white/5 rounded-2xl p-6 md:p-8">
        <form action="{{ route('admin.careers.store') }}" method="POST">
            ...
            <div class="flex items-center gap-4">
                <button type="submit" class="bg-gradient-to-r from-[#075749] to-[#9acb03] text-white font-semibold text-sm px-6 py-3 rounded-xl hover:scale-105 transition-all">Simpan Karir</button>
