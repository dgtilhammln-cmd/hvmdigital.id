            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4 lg:space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus
                        class="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-[#0a1f12] dark:text-white focus:border-[#9acb03] focus:ring-1 focus:ring-[#9acb03] transition-colors outline-none text-sm"
                    ...
                    <div>
                        ...
                        <div class="relative flex items-center" x-data="{ show: false }">
                            <input :type="show ? 'text' : 'password'" name="password" id="password" required
                                class="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 pr-10 text-[#0a1f12] dark:text-white focus:border-[#9acb03] focus:ring-1 focus:ring-[#9acb03] transition-colors outline-none text-sm"
