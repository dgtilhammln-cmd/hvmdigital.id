...
<section class="min-h-screen flex w-full">
    ...
    <div class="hidden lg:flex w-1/2 relative bg-[#075749] flex-col justify-between p-12 lg:p-16 border-r border-white/10">
        ...
        <div class="relative z-10 my-auto pt-20">
            <h1 class="text-6xl lg:text-7xl font-bold text-white tracking-tight mb-6" style="line-height: 1.1;">
                Selamat<br>
                <span class="text-[#9acb03] italic pr-2">datang.</span>
            </h1>
            <p class="text-white/80 text-lg font-light max-w-md leading-relaxed">
                Lanjutkan ke akun HVM Digital Anda untuk mengelola konten, pesanan, domain, dan website bisnis.
            </p>
        </div>
    ...
    {{-- Right Side (Form) --}}
    <div class="w-full lg:w-1/2 flex flex-col justify-between bg-white dark:bg-[#061009] p-8 sm:p-12 lg:p-16 xl:p-24">
        ...
        <div class="w-full max-w-sm mx-auto my-auto">
            <div class="mb-10">
                <h2 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-2 tracking-tight">Masuk ke akun.</h2>
                <p class="text-gray-500 dark:text-gray-400 text-sm font-light">Gunakan email dan password HVM Digital Anda untuk melanjutkan.</p>
            </div>

            @if (session('success'))
            <div class="mb-6 p-4 bg-green-50 text-green-700 text-sm font-medium border border-green-200">
                {{ session('success') }}
            </div>
            @endif
            ...
            <div class="mt-8 text-sm text-gray-500 dark:text-gray-400 font-light space-y-2">
                <p>Pertama kali masuk? <a href="{{ route('register') }}" class="font-medium text-gray-900 dark:text-white hover:underline">Daftar sekarang</a></p>
                <p>Lupa password? <a href="#" class="font-medium text-gray-900 dark:text-white hover:underline">Reset di sini</a></p>
                <p class="pt-2 text-xs">Masuk sebagai admin? <a href="{{ route('admin.login') }}" class="font-medium text-[#075749] dark:text-[#9acb03] hover:underline">Klik di sini</a></p>
            </div>
        </div>

        {{-- Bottom Right Footer (Mobile & Desktop) --}}
        <div class="mt-12 flex items-center justify-between lg:justify-end text-xs text-gray-400 dark:text-gray-500">
