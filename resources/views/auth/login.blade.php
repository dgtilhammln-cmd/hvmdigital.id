            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" required autofocus
                        class="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3.5 text-[#0a1f12] dark:text-white focus:border-[#9acb03] focus:ring-1 focus:ring-[#9acb03] transition-colors outline-none text-sm"
                ...
                <div>
                    ...
                    <div class="relative flex items-center" x-data="{ show: false }">
                        <input :type="show ? 'text' : 'password'" name="password" id="password" required
                            class="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3.5 pr-12 text-[#0a1f12] dark:text-white focus:border-[#9acb03] focus:ring-1 focus:ring-[#9acb03] transition-colors outline-none text-sm"
                            placeholder="&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;">
                        
                        <button type="button" @click="show = !show" class="absolute right-2 p-2 text-gray-400 hover:text-[#9acb03] focus:outline-none transition-colors">
