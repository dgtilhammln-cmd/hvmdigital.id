...
@section('title', 'Pendaftaran Berhasil - Giveaway Booth HVM Digital')
@section('meta_description', 'Pendaftaran Anda untuk Giveaway Booth HVM Digital berhasil! Pantau layar undian di booth kami.')
  ...
  <div class="success-hero relative overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-lg mx-auto px-6 py-12 text-center">
      ...
      <div class="mb-8 flex justify-center">
        <div
          class="check-circle w-28 h-28 bg-gradient-to-br from-[#9acb03] to-[#5a7a00] rounded-full flex items-center justify-center shadow-[0_0_60px_rgba(154,203,3,0.5)]">
          <svg class="w-14 h-14" viewBox="0 0 60 60" fill="none" stroke="white" stroke-width="4" stroke-linecap="round"
      ...
      <div class="content-anim">
        ...
        <p class="text-white/60 leading-relaxed mb-2">
          Selamat! <strong class="text-white">{{ session('nama_usaha') }}</strong> berhasil terdaftar dalam undian Giveaway di <strong
            class="text-[#9acb03]">Booth HVM Digital</strong> (Megpreneur 2026).
        </p>
        ...
        <div class="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 text-left space-y-3">
          ...
          <div class="flex items-start gap-3">
            <span
              class="w-5 h-5 bg-[#9acb03] rounded-full flex items-center justify-center text-xs font-black text-black shrink-0 mt-0.5">1</span>
            <p class="text-white/60 text-sm">Pastikan Anda masih follow <strong class="text-white">@hvmdigital.id</strong>
              di Instagram & TikTok hingga pengumuman.</p>
          </div>
          <div class="flex items-start gap-3">
            <span
              class="w-5 h-5 bg-[#9acb03] rounded-full flex items-center justify-center text-xs font-black text-black shrink-0 mt-0.5">2</span>
            <p class="text-white/60 text-sm">Catat nomor peserta <strong
                class="text-[#9acb03]">{{ session('nomor_peserta') }}</strong> untuk memudahkan identifikasi saat undian.
            </p>
          </div>
          <div class="flex items-start gap-3">
            <span
              class="w-5 h-5 bg-[#9acb03] rounded-full flex items-center justify-center text-xs font-black text-black shrink-0 mt-0.5">3</span>
