...
class MegpreneurController extends Controller
{
    ...
    public function submitForm(Request $request)
    {
        $request->validate([
            ...
            'foto_follow_ig'     => 'required|image|mimes:jpg,jpeg,png|max:6144',
            'foto_follow_tiktok' => 'required|image|mimes:jpg,jpeg,png|max:6144',
            'foto_selfie_booth'  => 'required|image|mimes:jpeg,png,jpg|max:6144',
